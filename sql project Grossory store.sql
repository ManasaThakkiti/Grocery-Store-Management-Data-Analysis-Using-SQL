...
select productid,name,avg(price) from products group by productid order by productid limit 5;

select c.categoryid,c.categoryname, avg(p.price) from categories c 
join products p on c.categoryid=p.categoryid
group by  c.categoryid,c.categoryname order by categoryid limit 5;
